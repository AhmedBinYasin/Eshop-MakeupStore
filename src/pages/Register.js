...
function Register({set}) {
  ...
  return (
    <div>
      <section className="vh-100" style={{backgroungColor:'#eee'}}>
        ...
        <div className="card text-black" style={{borderRadius: '25px'}}>
          <div className="card-body p-md-5">
                ...
                <form className="mx-1 mx-md-4">
                  ...
                  <div className="d-flex flex-row align-items-center mb-4">
                    ...
                    <div className="form-outline flex-fill mb-0">
                      <input type="text" id="form3Example1c" className="form-control" value={NameInput} onChange={onChangehandleName} onClick={onClickInputNameHandle}/>
                  ...
                  <div className="d-flex flex-row align-items-center mb-4">
                    ...
                    <div className="form-outline flex-fill mb-0">
                      <input type="email" id="form3Example3c" className="form-control" value={EmailInput} onChange={onChangehandleEmail} onClick={onClickInputEmailHandle}/>
                  ...
                  <div className="d-flex flex-row align-items-center mb-4">
                    ...
                    <div className="form-outline flex-fill mb-0">
                      <input type="password" id="form3Example4c" className="form-control" value={PaswordInput} onChange={onChangehandlePasword} onClick={onClickInputPaswordHandle}/>
                  ...
                  <div className="d-flex flex-row align-items-center mb-4">
                    ...
                    <div className="form-outline flex-fill mb-0">
                      <input type="password" id="form3Example4cd" className="form-control" value={ReenterPaswordInput} onChange={onChangehandleReenterPasword} onClick={onClickInputReenterPaswordHandle}/>
                      ...
                      <label className="form-label mx-2" htmlFor="form3Example4cd" style={{color: color}}>{Match}</label>
                    </div>
                  </div>
            ...
            <p className="small fw-bold mt-2 pt-1 mb-0">Already have an account? <a href="#!"
                className="link-danger" onClick={set}>Login</a></p>
          </div>
