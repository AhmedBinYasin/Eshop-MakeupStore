                                            ...
                                            <form className="mx-1 mx-md-4">
                                                ...
                                                <div className="d-flex flex-row align-items-center mb-4">
                                                    ...
                                                    <div className="form-outline flex-fill mb-0">
                                                        ...
                                                        <label className="form-label" htmlFor="form3Example4cd">password
                                                        </label>
                                                ...
                                                <div className="text-center text-lg-start mt-4 pt-2">
                                                    <Link to="/">
                                                        <button type="button" className="btn btn-primary btn-lg"
                                                            ...
                                                            onClick={onClickRegisterHandle}>Register</button>
                                                    </Link>
                                                    <p className="small fw-bold mt-2 pt-1 mb-0">Already have an account?
                                                        <Link to="/Links/LoginScreen" className="link-danger">Login</Link>
                                                    </p>
                                                </div>
